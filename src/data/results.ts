...
export const scoreboards: readonly Scoreboard[] = [
  {
    ...
    rows: [
      ...
      { award: '2nd', name: 'Artur Gilfanov', school: 'Fairview High School, CO' },
      {
        award: '3rd',
        name: 'Yancheng Zhao',
        school: 'Buckingham Browne & Nichols School, MA',
      },
      { award: null, name: 'Zachary Rogers', school: 'Brookline High School, MA' },
      { award: null, name: 'Leran Tao', school: 'Newton North High School, MA' },
      { award: null, name: 'Milo Chourmet', school: 'Roxbury Latin School, MA' },
